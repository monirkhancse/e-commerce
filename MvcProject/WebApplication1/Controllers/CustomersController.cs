...
namespace WebApplication1.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerId,CustomerName,Gender,DoB,Email,OrderId")] Customer customer)
        {
            ...
            ViewBag.OrderId = new SelectList(db.Orders, "OrderId", "OrderName", customer.OrderId);
            return View(customer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,CustomerName,Gender,DoB,Email,OrderId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
