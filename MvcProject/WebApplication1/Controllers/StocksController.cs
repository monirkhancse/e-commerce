...
namespace WebApplication1.Controllers
{
    public class StocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StockId,ProductId,StoreId,Quantity,Stutus")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StockId,ProductId,StoreId,Quantity,Stutus")] Stock stock)
        {
            if (ModelState.IsValid)
            {
